...
exports.ResetPasswordWithTokenDto = exports.ResetPasswordDto = void 0;
...
class ResetPasswordWithTokenDto extends ResetPasswordDto {
}
exports.ResetPasswordWithTokenDto = ResetPasswordWithTokenDto;
__decorate([
    (0, class_validator_1.IsString)({ message: 'Token must be a string' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Token must not be empty' }),
    __metadata("design:type", String)
