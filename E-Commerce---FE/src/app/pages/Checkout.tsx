import { Award, CheckCircle, Clock, CreditCard, Crosshair, Loader2, MapPin, Navigation, ShieldAlert, Store, Truck } from "lucide-react";
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                              <div className="flex items-start justify-between gap-2">
                                ...
                                {selected && <CheckCircle className="shrink-0 text-primary" size={18} />}
                              </div>
