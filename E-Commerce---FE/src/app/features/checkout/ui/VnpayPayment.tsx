import { CheckCircle, CircleX, Clock3, Loader2, ShieldCheck } from 'lucide-react';
...
export function VnpayPayment({ orderId, orderCode, setView }: VnpayPaymentProps) {
  ...
  const content = {
    ...
    paid: { icon: <CheckCircle size={42} />, title: 'Thanh toán VNPay thành công', description: 'Đơn hàng đã được xác nhận và chuyển sang xử lý.', tone: 'text-green-600 bg-green-50' },
