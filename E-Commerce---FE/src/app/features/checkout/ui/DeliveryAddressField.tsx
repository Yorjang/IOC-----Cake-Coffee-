import { CircleCheck, Crosshair, Loader2, MapPin } from "lucide-react";
    ...
    <div>
      ...
      <div className="relative">
        <div className="relative">
          ...
          {!isSearching && coordinates && <CircleCheck className="absolute right-3 top-3 text-green-600" size={17} />}
        </div>
