  ...
  return (
    <header className="sticky top-0 z-30 border-b bg-background/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3">
        ...
        {isLoggedIn ? (
          <button type="button" onClick={() => setView(VIEW_KEYS.PROFILE)} className={`rounded-full p-2 transition ${view === VIEW_KEYS.PROFILE ? "bg-primary text-primary-foreground" : "bg-secondary hover:bg-accent"}`} title={MESSAGES.HEADER_PROFILE}><User size={18} /></button>
        ) : (
